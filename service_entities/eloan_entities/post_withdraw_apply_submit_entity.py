...
REQUEST_HEADERS = (
    [{'name': 'X-UID', 'value': '213109'},
     ...
     {'name': 'Postman-Token',
      'value': 'a368262e-32ec-4cdc-89a5-c16e3703ad4d'},
...
class PostWithdrawApplySubmitEntity(BaseServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, apply_id=1, **kwargs):
        super(PostWithdrawApplySubmitEntity, 
            self).__init__(domain_name=domain_name,
                            url_string=URL.format(apply_id),
                            data=REQUEST_DATA,
...
if __name__ == '__main__':
    e = PostWithdrawApplySubmitEntity()
    e.send_request()
